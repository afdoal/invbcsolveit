...
$q = "SELECT wh_name,DATE_FORMAT(date,'%d/%m/%Y') AS date,KdBarang AS KdBarang3,KdBarang AS KdBarang2, NmBarang AS NmBarang2,Ket,HsNo AS HsNo2,Sat AS Sat2,FORMAT(qty, 2) AS qty
	  FROM mst_barang a 
